...
var connection = mysql.createConnection({
   ...
   connection.query('show tables', function(err, results) {
        ...
        event.reply([{ type: 'text', text: "請選擇成績單"},{
                ...
                //     actions: [{
                //       type: 'postback',
                //       label: results[4].Tables_in_line,
                //       data: results[4].Tables_in_line
                //     },{
                //       type: 'postback',
                //       label: results[5].Tables_in_line,
                //       data: results[5].Tables_in_line
                //     },{
                //       type: 'postback',
                //       label: results[6].Tables_in_line,
                //       data: results[6].Tables_in_line
                //     },{
                //       type: 'postback',
                //       label: results[7].Tables_in_line,
                //       data: results[7].Tables_in_line
                //     }]
                //   }
                // }
                ])
